...
The multivariate analysis plot shows a comparison of the liveness, acousticness and the speechness of each individual song in the corpus. There appears to be very a large bunch of songs with low acousticness and liveness. The speechness on the other hand seems all over the place, likely due to the vast differences in songs
