...
We can see in the plot the tempo and it's standard deviation, volume and song duration. I have made a seperation between music released by girl groups and boy groups since the styles differ and to hopefully have more interesting findings. We can see a similar distribution in tempo as was seen before. All durations are also similar and resemble typical songlenghts  
...
### Other Features
dance <- readRDS(file = "data/danceability_comparison_gg-plot.RDS")
dance
...
Seperating by girl and boy groups, but also the genres within the k-pop genre would help with having more interesing findings. 
